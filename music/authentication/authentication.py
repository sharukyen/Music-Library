...
def register():
    ...
    if form.validate_on_submit():
        ...
        try:
            services.add_new_user(form.user_name.data, form.password.data, repo.repo_instance)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            return redirect(url_for('track_blueprint.list_track'))
...
def logout():
    session.clear()
    return redirect(url_for('track_blueprint.home'))
